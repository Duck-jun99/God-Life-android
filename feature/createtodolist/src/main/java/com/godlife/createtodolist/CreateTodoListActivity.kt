        ...
        setContent{
            if (showExitDialog) {
                AlertDialog(
                    ...
                    title = {
                        Text(text = "투두 리스트 제작을 종료할까요?", style = TextStyle(color = PurpleMain, fontSize = 18.sp, fontWeight = FontWeight.Bold))
                    },
                    text = {
                    ...
                    confirmButton = {
                        GodLifeButtonWhite(
                            ...
                            text = { Text(text = "종료하기", style = TextStyle(color = PurpleMain, fontSize = 18.sp, fontWeight = FontWeight.Bold)) }
                        )
                    },
                    dismissButton = {
                        GodLifeButtonWhite(
